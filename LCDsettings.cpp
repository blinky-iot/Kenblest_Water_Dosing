...
void LCDsettings::displayStatus(bool manualMode, bool meterRunning, int target, float total, float batchAmount, bool update) {
...
void LCDsettings::manualDisplayStatus(bool manualMode, bool meterRunning, float total, float batchAmount) {
  clearLCDLine(0, 5);
  lcd.setCursor(5, 0);
  if (!manualMode) lcd.print("AUT");
  else lcd.print("MAN");
